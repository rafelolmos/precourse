...
function card() {
  for (var i = 0; i < 5; i++) {
    var m = carton.push(ballsPlaying[ballsPlaying.indexOf(getRandomCarton())]);
    Number(m)
    ballsPlaying.splice(m,1);
  };
};
...
numSerie(1,5)
console.log('bombo-->'+bombo)
console.log('ballsPlaying-->'+ballsPlaying)
